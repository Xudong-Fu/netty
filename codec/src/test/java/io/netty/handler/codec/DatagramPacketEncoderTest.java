...
public class DatagramPacketEncoderTest {
    ...
    public void testNotSharable() {
        DatagramPacketEncoder<AddressedEnvelope<ByteBuf, InetSocketAddress>> encoder =
                new DatagramPacketEncoder<AddressedEnvelope<ByteBuf, InetSocketAddress>>(
                        new MessageToMessageEncoder<AddressedEnvelope<ByteBuf, InetSocketAddress>>() {
                    @Override
        ...
        assertFalse(encoder.isSharable());
    }
